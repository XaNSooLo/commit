...
import { bgImages, icons, regions } from "../data";
    ...
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      const fetchCountry = async function (city) {
        ...
        const responce = await fetch(
          `https://api.openweathermap.org/data/2.5/weather?${param}&appid=f2b14ed2db88ed873fae598a98d5ba4f&units=metric `
        );
    ...
    >
      ...
      <div className="panel">
        ...
        <ul>
          ...
          <li>
            <span>Wind</span>
            <span>{weatherDetails.wind} km</span>
          </li>
        </ul>
      </div>
    </div>
